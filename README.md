...
There are six subfeatures, two for each of the free practice, qualifiying, and absolute pace postion grids. The free practice and pace grids were obtained by ordering the drivers by their fastest free practice and qualifying time, respectively. The absolute pace psoition grid is obtained by ordering the drivers by theie fastest time from both the qualifying and free practice times. Then the ALPC and the average absolute position change are taken for each. The absolute position change for a driver is the absolute value of how many positions they gained/lost and then the average absolute position change for a race is the average of each drivers absolute position change. 
