...
On thaeir own, each subfeature yields a correlation to the number of DNFs $<0.48$ but the weighted sum yields a correlation to the number of DNFs $0.539780855808356$. 
